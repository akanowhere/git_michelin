...
"""
Ricardo Costardi 10/06/2020
Ricardo Costardi 01/07/2020 - add servidor
"""
import os
import sys, errno
import logging
...
metrics.register_default(metrics.gauge('memory_usage', description='data about memory usage',
                                       labels={'memory_usage': dict(psutil.virtual_memory()._asdict())}))
...
def call_script():
    ...
    brokers_list = os.environ['KAFKA_HOSTS']
    ebpms.set_kafka_consumer(kafka_hosts=brokers_list,
