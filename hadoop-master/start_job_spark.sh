...
comando2="spark-submit --queue default --deploy-mode cluster --master yarn --driver-memory 3G --num-executors 2 --executor-cores 1 --executor-memory 2G --py-files /home/hadoop/sascar/spark_jobs/$1,$CONFIG --jars $JARS"
count_par=1 
