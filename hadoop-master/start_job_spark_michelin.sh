...
comando2="spark-submit --queue default --deploy-mode cluster --master yarn --driver-memory 3G --num-executors 2 --executor-cores 2 --executor-memory 4G --py-files /home/hadoop/sascar/spark_jobs/$1,$CONFIG --jars $JARS --packages com.databricks:spark-xml_2.11:0.4.1,org.postgresql:postgresql:42.1.1"
count_par=1 
