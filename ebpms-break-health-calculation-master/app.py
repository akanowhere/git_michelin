...
def call_script():
    ebpm_queue = QueueProcessor()

   
    
    ebpm_queue.set_database_connection(login=os.environ['SERVIDOR_BD_ORACLE_DW_SASCAR_LOGIN'],
    ...
    ebpm_queue.set_database_connection_postgre(login=os.environ['SERVIDOR_BD_POSTGRE_DOM_SASCAR_LOGIN'],
